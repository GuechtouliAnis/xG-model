...
class ModelEvaluation:
    ...
    def calculate_regression_metrics(self) -> dict:
        ...
        evaluator_mse = RegressionEvaluator(labelCol=self.result_col,
                                            predictionCol=self.prediction_col,
                                            metricName="mse")
        evaluator_rmse = RegressionEvaluator(labelCol=self.result_col,
                                             predictionCol=self.prediction_col,
                                             metricName="rmse")
        evaluator_mae = RegressionEvaluator(labelCol=self.result_col,
                                            predictionCol=self.prediction_col,
                                            metricName="mae")
        evaluator_r2 = RegressionEvaluator(labelCol=self.result_col,
                                           predictionCol=self.prediction_col,
                                           metricName="r2")
