...
class Preprocessing:
    ...
    def preprocess(self):
        ...
        # Convert to EDASparkDataFrame for Exploratory Data Analysis analysis
...
class EDASparkDataFrame:
    ...
    For example, if the underlying DataFrame has a column 'age',
    then eda_df.age will return an EDASparkColumn instance for 'age',
